...
class AccountMoveReversal(models.TransientModel):
    ...
    ei_correction_concept_credit_id = fields.Many2one(comodel_name='l10n_co_edi_shf.correction_concepts',
    ...
    def _prepare_default_reversal(self, move):
        ...
        if self.reason:
            ei_correction_concept_search = self.env['l10n_co_edi_shf.correction_concepts'].search([
                ('name', '=', self.reason),
                ('type_document_id', '=', 5)
            ])
