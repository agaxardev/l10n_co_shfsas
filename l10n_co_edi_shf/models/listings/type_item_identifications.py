...
class TypeItemIdentifications(models.Model):
    _name = "l10n_co_edi_shf.type_item_identifications"
    _inherit = "l10n_co_edi_shf.languages"
    _description = "Types of item identifications"

    code_agency = fields.Char(string="Agency code", required=False, readonly=True)
