...
class TypeEnvironments(models.Model):
    _name = "l10n_co_edi_shf.type_environments"
    _inherit = "l10n_co_edi_shf.languages"
    _description = "Environment types"

    url_qr = fields.Char(string="QR code url", required=True, readonly=True)
