...
class CorrectionConcepts(models.Model):
    _name = "l10n_co_edi_shf.correction_concepts"
    _inherit = "l10n_co_edi_shf.languages"
    _description = "Correction concept"

    # "id", "type_document_id", "name", "code", "api_code"
    type_document_id = fields.Integer(string="Document type", readonly=True)
