...
class AccountJournal(models.Model):
    ...
    resolution_invoice_id = fields.Many2one('l10n_co_edi_shf.resolution', string="Invoice resolution",
                                               ondelete='RESTRICT')
    resolution_credit_note_id = fields.Many2one('l10n_co_edi_shf.resolution', string="Credit note resolution",
                                                   ondelete='RESTRICT')
    resolution_debit_note_id = fields.Many2one('l10n_co_edi_shf.resolution', string="Debit note resolution",
                                                  ondelete='RESTRICT')
